...
ayaka_status_t validate_fused_add_rmsnorm(
    const ayaka_tensor_view_t *out, const ayaka_tensor_view_t *residual_out,
    const ayaka_tensor_view_t *input, const ayaka_tensor_view_t *residual,
...
extern "C" AYAKA_API ayaka_status_t ayaka_fused_add_rmsnorm(
    const ayaka_tensor_view_t *out, const ayaka_tensor_view_t *residual_out,
    const ayaka_tensor_view_t *input, const ayaka_tensor_view_t *residual,
    const ayaka_tensor_view_t *weight, float eps, ayaka_stream_t stream) {
